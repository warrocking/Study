MODULE MainModule
    ...
    !========================
    ! desktop-mcn21av (4abb 담당자) Tailscale IP - this controller runs on that PC,
    ! so ROBOT_IP must be this machine's own reachable address, not 3abb/5abb's LAN IP.
    CONST string ROBOT_IP := "100.102.179.115";
